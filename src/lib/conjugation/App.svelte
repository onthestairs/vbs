<script>
  ...
  import verbs from "../../data/verbs/verbs.json";
  import top100 from "../../data/verbs/top-100.json";
  import group2 from "../../data/verbs/2e-groupe.json";
  import group3 from "../../data/verbs/3e-groupe.json";
